...
import com.xu.xmaster.activities.MusicActivity;
import com.xu.xmaster.beans.MusicModel;
import com.xu.xmaster.providers.MusicWidgetProvider;
...
public class MusicService extends Service {
    ...
    private void initView() {
        MusicModel musicModel = mPlayerView.getMusicModel();
        views.setTextViewText(R.id.mn_text, musicModel.getSongname() + " - " + musicModel.getSinger());
    ...
    private void setPlayIcon(int icon) {
        ...
        protected Bitmap doInBackground(String... strings) {
            ...
            try {
                bitmap = Glide.with(getApplicationContext())
                        .asBitmap()
                        .load(strings[0])
                        .placeholder(R.drawable.pic_cat)
                        .submit()
                        .get();
    ...
    private PendingIntent startActivity() {
        return PendingIntent.getActivity(this,
                NOTIFICATION_CODE,
                new Intent(this, MusicActivity.class).putExtra("startFromNotification", true),
