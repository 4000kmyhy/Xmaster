...
public class MusicWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        views.setImageViewResource(R.id.mw_albumimg, R.drawable.pic_cat);
    ...
    private void updatePlayer(Context context, MyMusicPlayerView mPlayerView) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.music_widget);
        views.setTextViewText(R.id.mw_text, musicModel.getSongname() + " - " + musicModel.getSinger());
    ...
    private PendingIntent startActivity(Context context) {
        return PendingIntent.getActivity(context,
                WIDGET_CODE,
                new Intent(context, MusicActivity.class),
