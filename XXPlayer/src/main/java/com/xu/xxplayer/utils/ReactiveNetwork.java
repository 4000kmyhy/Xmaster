...
public class ReactiveNetwork {
     ...
     * @return
     */
    public io.reactivex.Observable<ConnectivityStatus> observeNetworkConnectivity(final Context context) {
        final IntentFilter filter = new IntentFilter();
        filter.addAction(ConnectivityManager.CONNECTIVITY_ACTION);

        return io.reactivex.Observable.create(new ObservableOnSubscribe<ConnectivityStatus>() {
            @Override
     ...
     * @return
     */
    public io.reactivex.Observable<Boolean> observeInternetConnectivity() {
        return io.reactivex.Observable.interval(2000, TimeUnit.MILLISECONDS, Schedulers.io())
     ...
     * @return
     */
    public io.reactivex.Observable<ConnectivityStatus> observeWifiSwitch(final Context context) {
        final IntentFilter filter = new IntentFilter();
